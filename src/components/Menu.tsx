            ...
            <div className="absolute top-0 mt-[48px] overflow-hidden">
                <div className={`group/menu md:absolute md:h-0 w-[100vw] bg-line transition-transform duration-200 ease-in-out
                  ${showMenu ? '' : '-translate-y-full'}`}>
                    <a className="flex group hover:bg-accent_pink" href="/projects">
                        ...
                        <div
                            className="py-4 pl-4 text-xl font-bold text-accent_purple block group-hover:text-dark_blue group-hover:border-b-[1.5px] group-hover:border-accent_pink">
                            projects
                        </div>
                    </a>
                    ...
                    <a className="flex group hover:bg-accent_pink" href="/musings">
                        {/* !Font Awesome Pro 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2024 Fonticons, Inc */}
                        <svg className="h-6 mt-[18px] ml-3.5 fill-accent_purple group-hover:fill-dark_blue "
                             xmlns="http://www.w3.org/2000/svg"
                             viewBox="0 0 576 512">
                            <path className="fa-secondary" opacity=".4"
